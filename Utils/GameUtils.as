    ...
    if (map !is null)
    {
        ...
        if (playground !is null && script !is null && playground.GameTerminals.Length > 0)
        {
            ...
            if (player !is null)
            {
                ...
                bool finished =
                    UISequence == SGamePlaygroundUIConfig::EUISequence::Finish
                    || UISequence == SGamePlaygroundUIConfig::EUISequence::UIInteraction;
...
#if MP4
    titleId = titleId.SubStr(0, titleId.IndexOf("@"));
#endif
